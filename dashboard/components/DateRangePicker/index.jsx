    ...
    return (
        <div className="filter-container-date-range">
            ...
            <div className="dropdown">
                <button type="button" className={`dropdown-button dropdown-button--${containerStyle}`}>
                ...
                <div className="dropdown-content">
                    ...
                    <button type="button" className={`apply-button apply-button--${btnStyle}`} onClick={clearDate}>
                        {t("clear")}
                    </button>
                </div>
            </div>
